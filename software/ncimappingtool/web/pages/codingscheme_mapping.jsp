  ...
  <table border="0" width="700px">
		  ...
		  <td align="left" class="textbody">
		      <b>To</b>:
                  ...
                  <td class="textbody">
                    <select id="target_cs" name="target_cs" size="1" tabindex="4">
                    <%
		       for (int i=0; i<cs_label_vec.size(); i++) {
			    t = (String) cs_label_vec.elementAt(i);
			    if (t.compareTo(target_cs) == 0) {
			    %>
				   <option value="<%=t%>" selected><%=t%></option>
			    <%
			    } else {
...
<!--
	    ...
	    <input type="radio" name="input_option" value="Property" alt="Property" <%=property_checked%> >Property&nbsp;
...
<tr><td>&nbsp;</td></tr>    
          ...
          <input type="hidden" name="input_option" id="type" value="Code">
